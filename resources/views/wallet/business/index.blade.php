...
@section('scripts_content')
  <script src="{{ asset('js/portal/wallet/business/index.js') }}"></script>
@endsection
      ...
      <div class="x_title">
        <div class="br-pageheader pd-y-15 pd-l-20">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Comercios</span>
          </nav>
        </div><!-- br-pageheader -->
        ...
        <table width='100%' style="margin-bottom: 40px;">
          <tr>
              <td width='50' align="center" valign="top" class="pr-4">
                  <h1 class="text-primary"><i class="fa fa-shopping-bag" aria-hidden="true"></i></h1>
              </td>
              <td>
                  <h4 class="tx-gray-800 mg-b5" style="margin-bottom: 0px;">Comercios</h4>
        ...
        <div class="row row-sm mb-4 text-center">
          <div class="col-sm-12">
            <button id="btn-new-step" class="btn btn-primary btn-sm" style="margin-bottom: 1px;">
                <i class="fa fa-plus-square-o mr-2"></i>Nueva comercio
            </button>
          </div>
        </div>
          ...
          <div class="modal-dialog" role="document" style="width: 800px;">
            <div class="modal-content">
              <div class="modal-header text-white bg-primary">
                <h6 class="modal-title" id="exampleModalLabel"><i class="fa fa-shopping-bag mr-2" aria-hidden="true"></i>COMERCIO</h6>
                    ...
                    <div class="row">
                      <div class="col-xl-12">
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                  {!! Form::label('name','Nombre comercio <span class="text-danger">*</span>',[],false) !!} 
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                  ...
                                  {!! Form::text('address', null, array('id' => 'address','class' => 'form-control form-control-sm','required' => 'required', 'style' => 'height: 25px;', 'required'=>'required' )) !!}
                                </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                  ...
                                  {!! Form::text('phone', null, array('id' => 'phone','class' => 'form-control form-control-sm','required' => 'required', 'style' => 'height: 25px;', 'required'=>'required' )) !!}
                                </div>
                            </div>
                          </div>
                          <div class="row">
