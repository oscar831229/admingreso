        ...
        <table width='100%' style="margin-bottom: 40px;">
          <tr>
              <td width='50' align="center" valign="top" class="pr-4">
                <h1 class="text-primary"><i class="fa fa-universal-access" aria-hidden="true"></i></h1>
              </td>
              <td>
                    ...
                    <div class="col-xl-12 mg-t-20 mg-xl-t-0">
                        <div class="form-layout form-layout-5 bd-info">
                            ...
                            <div class="row text-center">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <button class="btn btn-success btn-block btn-sm" id="btn-save-agreement"><i class="fa fa-floppy-o mg-r-10"></i> Guardar </button>
                                    </div>
                                </div>
                            </div>
