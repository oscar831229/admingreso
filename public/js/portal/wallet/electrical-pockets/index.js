...
step = {
  ...
  loadSteps : function(){
    ...
    $.ajax({
      url: '/wallet/details-electrical-pockets',
      async: true,
      data: {},		
      beforeSend: function(objeto){
      },        
  ...
  editStep : function(){
    ...
    setTimeout(function(){
      $.ajax({
          url: 'electrical-pockets/' + step_id,
          async: true,
          data: {},		
          beforeSend: function(objeto){
  ...
  changeOperationType : function(){
    var operation_type = $(this).val();
    if(operation_type == 'T'){
      $('.possibly-required-row').show();
      $('#minimum_purchase').attr('required', true);
      $('#unit_value').attr('required', true);
    }else{
      $('.possibly-required-row').hide();
      $('#minimum_purchase').attr('required', false);
      $('#unit_value').attr('required', false);
    }
  ...
  init : function(){
    ...
    $('body').on('change', '#operation_type', this.changeOperationType);
