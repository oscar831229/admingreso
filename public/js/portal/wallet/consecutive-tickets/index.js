...
step = {
    ...
    swal({
      ...
      buttons: {
        ...
        if (value) {
          ...
          setTimeout(function(){
            $.ajax({
                url: '/wallet/consecutive-tickets',
                async: true,
                data: formadata,		
  ...
  showListSteps : function(){
    ...
    $.each(step.steps, function(index, value){
      ...
      +'     <td>'+value.id+'</td>'
      +'     <td>'+value.prefix+'</td>'
      +'     <td>'+value.initial_consecutive+'</td>'
      +'     <td>'+value.final_consecutive+'</td>'
      +'     <td>'+value.current_consecutive+'</td>'
  ...
  loadSteps : function(){
    ...
    $.ajax({
      url: '/wallet/details-consecutive-tickets',
      async: true,
      data: {},		
      beforeSend: function(objeto){
      },        
  ...
  editStep : function(){
    ...
    setTimeout(function(){
      $.ajax({
          url: 'consecutive-tickets/' + step_id,
          async: true,
          data: {},		
          beforeSend: function(objeto){
