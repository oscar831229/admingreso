...
function countChecked() {
    ...
    "all"  === checkState && $(".bulk_action input.check-affiliate").iCheck("check"),
    "none" === checkState && $(".bulk_action input.check-affiliate").iCheck("uncheck");
    // var e = $(".bulk_action input[name='table_records']:checked").length;
    // e ? ($(".column-title").hide(),
    // $(".bulk-actions").show(),
    // $(".action-cnt").html(e + " Registros seleccionados")) : ($(".column-title").show(),
    // $(".bulk-actions").hide())
}
