...
class OfficialsReportLinked
{
	public static $filename = 'funcionarios_vinculados.xlsx';
	...
	public function getData(){
        ...
        # DATOS PERSONA
        $people = $people->getPeopleCompanyVinculation($this->request)->toArray();
    ...
    public function getEstructView(){
        return 'Officials.report-management.struct.officials-report-linked';
    }
