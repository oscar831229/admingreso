...
class DisaggregatedBudgetReport
{
	public static $filename = 'desagregado_cuipo.xlsx';
    ...
    public static $columns = [
        ...
        'Valor detalle obligacion',
        'Valor detalle orden de pago'
    ];
	...
	public function getData(){
        ...
        $querySQL = "DECLARE 
            ...
            SELECT * FROM desagregado_consolidado_dane ORDER BY commitment_id, dane_code_id";
    ...
    public function getEstructView(){
        return 'BudgetManagement.report-management.struct.disaggregated-budget-report';
    }
