...
class CrearMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $menus = [
            ...
            array('id' => '13' , 'menu_id'  => '7' , 'nombre' => 'Parametrización servicios'  , 'url' => 'income/parameterization-services'    , 'orden' => '14'  , 'icono' => NULL, 'created_at' => $now, 'updated_at' => $now),
            array('id' => '14' , 'menu_id'  => '7' , 'nombre' => 'Parametrizacion empresas'   , 'url' => 'income/parameterization-companies'   , 'orden' => '15'  , 'icono' => NULL, 'created_at' => $now, 'updated_at' => $now),
            array('id' => '15' , 'menu_id'  => '7' , 'nombre' => 'Parametrización convenios'  , 'url' => 'income/parameterization-agreements'  , 'orden' => '16'  , 'icono' => NULL, 'created_at' => $now, 'updated_at' => $now),
